                ...
                <ul className="flex -m-2.5">
                  <li className="relative m-2.5">
                    <Link
                      ...
                      to="#"
                    >
                      <img src={require('../../../static/img/icon/ltr.png')} alt="" />
                      <FontAwesome
                  ...
                  <li className="relative m-2.5">
                    <Link
                      ...
                      to="#"
                    >
                      <img src={require(`../../../static/img/icon/rtl.png`)} alt="" />
                      <FontAwesome
                        className={rtl ? 'block absolute top-4 right-4 text-success' : 'hidden'}
                        name="check-circle"
                      />
                ...
                <ul className="flex -m-2.5">
                  <li className="relative m-2.5">
                    <Link
                      ...
                      to="#"
                    >
                      <img src={require('../../../static/img/icon/light.png')} alt="" />
                      <FontAwesome
                  ...
                  <li className="relative m-2.5">
                    <Link
                      ...
                      to="#"
                    >
                      <img src={require(`../../../static/img/icon/dark.png`)} alt="" />
                      <FontAwesome
                ...
                <ul className="flex -m-2.5">
                  <li className="relative m-2.5">
                    <Link
                      ...
                      to="#"
                    >
                      <img src={require('../../../static/img/icon/side.png')} alt="" />
                      <FontAwesome
                  ...
                  <li className="relative m-2.5">
                    <Link
                      ...
                      to="#"
                    >
                      <img src={require(`../../../static/img/icon/top.png`)} alt="" />
                      <FontAwesome
                        className={topMenu ? 'block absolute top-4 right-4 text-success' : 'hidden'}
                        name="check-circle"
                      />
